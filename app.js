...
(function() {
  var bioData = {
    ...
    banerjea: {
      ...
      bio: 'Gautam Banerjea serves as Chairman of the Board of Cyber Profound, where he leads execution of the company\'s national cybersecurity consolidation strategy, oversees platform integration, and drives enterprise expansion across priority verticals.\n\nMr. Banerjea brings more than three decades of senior leadership experience in enterprise technology, cloud transformation, and large-scale P&L management. Prior to joining Cyber Profound, he held multiple executive roles at IBM over a 17-year tenure, including Vice President and Senior Client Partner.\n\nMr. Banerjea has directed multi-billion-dollar P&Ls, driving consistent growth and delivering complex modernization programs across Retail, CPG, Travel, Transportation, and Healthcare industries. He has pioneered large-scale cloud migrations, integrated AI-driven solutions, and championed agile enterprise models that accelerate innovation and reduce cost. He has worked extensively across North America, Europe, and Asia-Pacific, leading multicultural teams and delivering mission-critical programs in over 50 countries.\n\nHis leadership experience spans hybrid cloud architecture, DevSecOps modernization, AI-enabled automation, enterprise application transformation, and large-scale Agile operating model deployments. Earlier in his career, Mr. Banerjea held senior leadership roles at Ernst and Young, CapGemini, HP, and EDS.\n\nHe holds a Master of Science in Information Systems from The University of Texas at Dallas and a Master of Science in Applied Economics from Birla Institute of Technology and Science.\n\nAt Cyber Profound, Mr. Banerjea is focused on building a disciplined, enterprise-grade cybersecurity platform through structured acquisitions, operational integration, and long-term value creation.'
    },
    miller: {
      name: 'Susan Miller',
      role: 'Chief Executive Officer',
      photo: './assets/headshot-miller.jpg',
      linkedin: 'https://www.linkedin.com/in/susanroxstrommiller/',
      bio: 'Susan Miller serves as Chief Executive Officer of Cyber Profound, where she leads the company\'s overall strategy, executive leadership, and operational governance as the company grows its national cybersecurity consolidation platform.\n\nSusan Miller brings more than three decades of senior leadership experience in cybersecurity, AI security governance, and enterprise operations across global technology organizations. Prior to joining Cyber Profound, she spent 16 years at Oracle Corporation, most recently as Senior Director, AI Security & Technical Enablement, where she led AI security governance across all divisions and influenced global operational execution spanning cloud infrastructure, industry services, enterprise software applications including ERP, HCM, and SCM, and database technologies. Her earlier roles at Oracle included Director of Security Assurance and Director of Product & Security Release Management. Before Oracle, she held senior engineering and program leadership positions at Sun Microsystems and GTE.\n\nSusan Miller has built and led a senior security leadership community of more than 100 executives, driving cross-organizational collaboration and establishing executive communication forums that provide direction and guidance across complex, multi-division enterprises. Her leadership experience spans AI security and responsible AI governance, enterprise cybersecurity strategy, DevSecOps and secure software lifecycle oversight, security assurance and risk management, regulatory compliance and privacy, and global program and operations leadership. She is recognized for translating technical exposure into enterprise-level decisions and for serving as a bridge between technical and executive leadership.\n\nSusan Miller is a Founding Board Member of AIUC-1 and serves as a Director on the Board of Directors of Athena. Her prior board and governance service includes Director and Treasurer of the Palomar College Foundation, Director and Nominations Chair of the North San Diego Business Chamber, Director of the Gary Sinise Foundation San Diego Chapter, and Vice President of Strategic Planning on the Board of PMI San Diego.\n\nShe holds an MBA, a Master of Science in Computer Science Engineering with a focus on Artificial Intelligence, and a Bachelor of Science in Computer Science and Mathematics, all from Santa Clara University. She holds the CISSP, CISM, PMP, and CIPT certifications.\n\nAt Cyber Profound, Susan Miller is focused on building a disciplined operating foundation that integrates acquired companies into a cohesive enterprise platform, embeds rigorous security and governance practices across the portfolio, and supports the long-term execution of the company\u2019s national cybersecurity consolidation strategy.'
    },
    singh: {
...
(function() {
  ...
  var searchIndex = [
    ...
    { page: 'Leadership', title: 'Susan Miller — Chief Executive Officer', desc: 'AI and cybersecurity executive with 30+ years leading AI security governance, security assurance, and enterprise operations at Oracle and Sun Microsystems.', url: './index.html#leadership' },
